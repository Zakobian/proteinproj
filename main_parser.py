...
parser.add_argument('--seed', type=int, default=1, metavar='SD',
                    help='random seed (default: 1)')
parser.add_argument('--setup', type=int, default=1, metavar='S',
                    help='setup (1 or 2 for different datasets)(default: 1)')
parser.add_argument('--log-interval', type=int, default=50, metavar='L',
                    help='how many batches to wait before logging training status')
parser.add_argument('--iterates', type=int, default=100,
                    help='how many iterates for algorithms like LG or LPD')
...
parser.add_argument('--cp-interval', type=int, default=5000, metavar='C',
                    help='how many batches to\
                            wait before saving a checkpoint')
parser.add_argument('--data-path', type=str, default='/local/scratch/public/zs334/bio/',#default='/home/zs334/rds/hpc-work/CompFrm/',
                    help='path to the data')
parser.add_argument('--alg', type=str, default='compare',
                    help='FBP,TV,FBP+U,FL,LG,LPD,TV')
...
parser.add_argument('--res', type=float, default=2.8, metavar='RES',
                    help='Value of constant resolution')
parser.add_argument('--alpha', type=float, default=1e-3, metavar='ALP',
                    help='Value of constant alpha')
