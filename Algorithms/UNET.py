...
class UNet3D(Abstract3DUNet):
    ...
    def __init__(self, in_channels, out_channels, final_sigmoid=False, f_maps=16, layer_order='cr',
...
class Algorithm(BaseAlg.baseNet):
    def __init__(self,args,data_loaders,path=config.data_path+'nets/'):
        super(Algorithm, self).__init__(args,path,UNet3D(1,1),data_loaders)
